@extends('layouts.base', ['title' => 'Shop Sidebar Right || Business Consulting Consulting', 'logo' => '/img/logo/titel1.svg'])
                                        ...
                                        <div class="range-slider-output">
                                            ...
                                            <div class="number-group">
                                                $<input class="number-input" type="number" value="100"
                                                    min="0" max="500"><span
                                                    class="range-output-divider">-</span> $<input class="number-input"
                                                    type="number" value="350" min="0" max="500">
                                            </div>
                                        </div>
                                    </div>
                                </div>
