@extends('layouts.base', ['title' => 'Blog 2 || Advisr Tax Consulting', 'logo' => '/img/logo/titel1.svg'])
                ...
                <div class="col-lg-6">
                    <div class="blog1-single-box active page-blog1-single-box">
                        ...
                        <div class="blog1-hadding">
                            ...
                            <h4><a href="{{ route('second', ['blog-details', 'index'])}}">How consultation in business is affecting new ventures </a>
                            </h4>
