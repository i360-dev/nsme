@extends('layouts.base', ['title' => 'Blog Sidebar Left || Advisr Tax Consulting', 'logo' => '/img/logo/titel1.svg'])
                        ...
                        <div class="col-lg-6">
                            <div class="blog1-single-box active page-blog1-single-box">
                                ...
                                <div class="blog1-hadding">
                                    ...
                                    <div class="space14"></div>
                                    <h4><a href="#">Customized Solutions: Based on our analysis, we develop </a></h4>
                                    <div class="space30"></div>
                                    <a class="learn-more1" href="{{ route('second', ['blog-details', 'index'])}}">Read More<span><i
                                                class="fa-solid fa-arrow-right"></i></span></a>
                                </div>
