...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="header-elements">
                            <div class="site-logo home1-site-logo">
                                <a href="{{ route('second',['landing', 'index'])}}"><img src="/img/logo/header-logo8.svg" alt="" />
                                </a>
                            </div>



                            <div class="main-menu-ex main-menu-ex8">
                                <ul>
                ...
                <div class="col-lg-6 col-md-12 _relative">
                    <div class="main-hadding8">
                        ...
                        <p>Your Partner in Achieving Sustainable Growth and Success,Unlock Your <br> Potential and Drive
                            Growth. We help business to perform</p>
                ...
                <div class="col-lg-6">
                    <div class="hadding8 about8-hadding">
                        ...
                        <p data-aos="fade-left" data-aos-duration="1100">At Advisor Consulting Company, we are a trusted
                            business consulting firm dedicated to helping businesses thrive and reach their full potential.
                            Consult
                            our team of experienced consultants brings diverse industry knowledge & expertise in various
                            business disciplines. We prioritize understanding </p>
                        <div class="space20"></div>
                        <p data-aos="fade-left" data-aos-duration="800">Your unique challenges and goals to deliver
                            customized solutions tailored to your specific needs We are committed to providing exceptional
                            service innovative strategies, and tangible results for our clients.</p>
    ...
    <div class="service8 sp3" id="service" style="background-color: #E9EDF4;">
        <div class="container">
            <div class="row">
                        ...
                        <div class="service8-box">
                            ...
                            <div class="hadding8">
                                ...
                                <p>Consultants analyze current operations and identify areas for improvement in efficiency,
                                    productivity, and cost reduction.</p>
                                <div class="space16"></div>
    ...
    <div class="progress8 sp3" id="progress">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="hadding8 progress8-hadding">
                        ...
                        <p data-aos="fade-right" data-aos-duration="1000">At Taxvice Business Consulting, we specialize in
                            helping businesses achieve their full potential. Whether you're a startup looking to establish a
                            strong.</p>
                        <div class="space16"></div>
                        <p data-aos="fade-right" data-aos-duration="700">It's important to note that consulting services
                            can vary in their approach and methodology, and the specific services offered will depend.</p>
    ...
    <div class="case8 sp3" id="case" style="background-color: #E9EDF4;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto text-center">
                    <div class="hadding8">
    ...
    <div class="tes8 sp3" id="testimonial">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto text-center">
                    <div class="hadding8">
    ...
    <div class="blog8 sp3" id="blog" style="background-color: #E9EDF4;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto text-center">
                    <div class="hadding6">
