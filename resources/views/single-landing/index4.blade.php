...
@section('content')
    <!--=====HEADER START=======-->
    <header>
        <div class="header-area header-area4 header-area-all d-none d-lg-block" id="header2">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="header-elements">
                            <div class="site-logo home1-site-logo">
                                <a href="{{ route('second',['landing', 'index'])}}"><img src="/img/logo/header4-logo.svg" alt="" />
                                </a>
                            </div>


                            <div class="main-menu-ex main-menu-ex4">
                                <ul>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="main-hadding4">
                        ...
                        <p>Maximize Your Tax Saving and Ensure Compliance.We help businesses to perform with our customized
                            solutions helping them take business decisions.</p>
                ...
                <div class="col-lg-6">
                    <div class="hadding4 about4-hadding">
                        ...
                        <p data-aos="fade-left" data-aos-duration="900">At Advisor Consulting, we are a trusted finance
                            consulting firm dedicated to helping businesses achieve financial excellence and sustainable
                            growth.Whether your dream is to retire well or build a profitable busines JS Morlu offers a
                            diverse range of exclusive accounting, tax, on audit and business advisory</p>
    ...
    <!--=====service start=======-->
    <div class="service4 sp3" id="service" style="background-color: #EEF1F7;">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 m-auto text-center">
                    <div class="hadding4">
                        ...
                        <div class="space16"></div>
                        <p data-aos="fade-up" data-aos-duration="800">Our team of experienced consultants combines
                            industry knowledge, cutting-edge technology, and innovative strategies to guide you towards a
                            brighter and greener future. </p>
                    </div>
                </div>
            </div>
            <div class="space30"></div>
                        ...
                        <div class="service4-box">
                            ...
                            <div class="hadding4">
                                ...
                                <p> Our experienced consultants help businesses develop comprehensive financial plans,
                                    perform financial forecasting,</p>
                                <div class="space24"></div>
    ...
    <!--=====testimonial start=======-->
    <div class="testimonial1 testimonial4 sp4" id="testimonial">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    ...
                    <div class="trusred-slider-all owl-carousel">
                        <div class="testimonial1-hadding">
                            ...
                            <p>
                                ...
                                complex organizational change, ensuring a smooth transition and positive employee
                                engagement." . Their strategic insights and guidance helped us double our revenue within a
                                year."
                            </p>
                            <div class="space24"></div>
                ...
                <div class="col-lg-7 m-auto text-center">
                    <div class="hadding4-w">
                        ...
                        <p data-aos="fade-up" data-aos-duration="800">Take advantage of a one on one consultation with our
                            tax experts. We'll assess your unique situation and provide personalized advice and strategies.
                        </p>
                        <div class="space40"></div>
                    ...
                    <div class="blog4-box" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <div class="hadding4 blog4-hadding">
                            ...
                            <p>Technology and Startups: Our finance consultants understand the financial challenges faced by
                                technology companies and startups. in financial modeling,</p>
                            <div class="space24"></div>
