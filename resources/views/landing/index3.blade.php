...
<!--=====HEADER START=======-->
<x-topbar logo="/img/logo/header3-logo.svg" exClass="3">
    ...
    <div class="row align-items-center">
      <div class="col-lg-6 col-md-12">
        <div class="main-hadding3">
          ...
          <p>Maximize Your Tax Saving and Ensure Compliance.We help businesses to perform with our customized solutions
...
<!--=====serivce start=======-->
<div class="service3 sp3" style="background-color: #333982;">
  <div class="container">
    <div class="row">
      <div class="col-lg-7 m-auto text-center">
        <div class="hadding3-w">
          ...
          <p data-aos="fade-up" data-aos-duration="800">Our team of experienced consultants combines industry knowledge,
            cutting-edge technology, and innovative strategies to guide you towards a brighter and greener future. </p>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="service3-box-all border3-right p3-left after3-service2" data-aos="fade-up" data-aos-duration="900">
          <div class="service3-box-icon">
      ...
      <div class="col-lg-4">
        <div class="service3-box-all border3-top border3-right p3-left" data-aos="fade-up" data-aos-duration="1000">
          <div class="service3-box-icon">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6">
        <div class="hadding3 about-hadding3">
          ...
          <div class="space24"></div>
          <p data-aos="fade-left" data-aos-duration="800">At Toxa tax Consulting Company, we are a trusted tax
            consulting firm with over 15 years of experience. Our mission is to provide exceptional tax services,
            personalized attention, and expert guidance to individuals and businesses. Our team of seasoned
            professionals</p>
          <div class="space20"></div>
          <p data-aos="fade-left" data-aos-duration="1000">has in-depth knowledge of tax laws,regulations, and industry
            best practices. We stay up-to-date with the latest changes in tax legislation to ensure we provide accurate
    ...
    <div class="row">
      <div class="col-lg-5">
        <div class="hadding3-w mission-hadding">
          <h1 data-aos="fade-right" data-aos-duration="700">Why Our mission is to provide exceptional tax services</h1>
          <div class="space24"></div>
          <p data-aos="fade-right" data-aos-duration="700">Flexible energy service is a key part of the future of
            energy. It can help you save money on your electricity bill, and it can also help to reduce your carbon
            footprint.We have a track.</p>
          <div class="space40"></div>
          <a data-aos-duration="700" data-aos="fade-right" class="buttonBox2 fifth" href="{{ route('second', ['others', 'about'])}}">About Us</a>
        </div>
      </div>
      <div class="col-lg-7">
        <div class="mission-boxs-all">
          <div class="mission-box" data-aos="fade-left" data-aos-duration="700">
            ...
            <div class="mission-hadding hadding3-w">
              ...
              <p>Our team of seasoned professionals has in-depth knowledge of tax laws, regulations, and industry best
    ...
    <div class="row align-items-center">
      <div class="col-lg-7">
        <div class="hadding3">
          ...
          <div class="space16"></div>
          <p data-aos="fade-up" data-aos-duration="800">Flexible energy service is a key part of the future of energy.
            It can help you save money on your electricity bill, and it can also help to reduce your carbon footprint.
          </p>
        </div>
      </div>
      <div class="col-lg-5 text-right">
        <div class="featured-button">
          <div class="">
            <a data-aos="fade-up" data-aos-duration="700" class="buttonBox2 fifth" href="{{ route('second', ['pages', 'case'])}}">View Full Case
              Studies</a>
          </div>
        </div>
      </div>
...
<!--=====testimonial start=======-->
<div class="testimonial3 sp3" style="background-color: #333982;">
  <div class="container">
    <div class="row">
      <div class="col-lg-7 m-auto text-center">
        <div class="hadding3-w">
          <h1 data-aos="fade-up" data-aos-duration="700">Our Testimonials, Don't just take our word for it!</h1>
        </div>
      </div>
    </div>
          ...
          <div class="testimonial3-slider owl-carousel">
            <div class="testimonial3-single-slider">
              <div class="testimonial3-hadding">
                ...
                <p>
                  "Professional,reliable,and thorough.Toxa Consulting guided us through complex tax matters with ease.A
                  true partner Download our comprehensive guides and ebooks on tax planning, deductions, and compliance
                  to enhance your understanding of tax-related matters, A true partner! Download our comprehensive
    ...
    <div class="row">
      <div class="col-lg-7 m-auto text-center">
        <div class="hadding3">
          ...
          <div class="space16"></div>
          <p data-aos="fade-up" data-aos-duration="900">Consulting service is a key part of the future of energy. It can
            help you save money on your electricity bill, and it can also help to reduce your carbon footprint.</p>
        </div>
      </div>
    </div>
    <div class="space30"></div>
      ...
      <div class="col-lg-4">
        <div class="blog3-box-all" data-aos="fade-up" data-aos-duration="700">
          ...
          <div class="hadding3 blog3-hadding">
            <ul>
              <li style="display: inline-block;"><a href="#" class="date2">15 March, 2023 /</a></li>
              <li style="display: inline-block;"><a href="#" class="date2">Uncategorized</a></li>
            </ul>
            <div class="space16"></div>
            <h4><a href="{{ route('second', ['blog-details', 'index'])}}">Explore our regularly updated blog, where we share expert tips, industry
                trends.</a></h4>
            <div class="space24"></div>
      ...
      <div class="col-lg-6 contect3-bg1"
        ...
        <div class="contect3-touch-hadding">
          <div class="hadding3-w">
            ...
            <div class="space16"></div>
            <p data-aos="fade-right" data-aos-duration="800">We are here to help you feel happy and healthy again
              through our revolutionary healthcare model that's evidence-based, supportive, and personalized to you.</p>
          </div>
          ...
          <div class="contact2-contacts">
            ...
            <div class="contact2-single" data-aos="fade-right" data-aos-duration="1000">
              ...
              <div class="contact2-icon-hadding">
                <a href="tel:281-377-7891">8708 Technology Forest Pl Suite <br> 125 -G, The Woodlands, TX 77381</a>
              </div>
            </div>
          </div>
          <div class="space30"></div>
