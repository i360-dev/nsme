@extends('layouts.base', ['title' => 'Home 6 || Business Consulting Consulting', 'logo' => '/img/logo/titel6.svg'])
...
@section('content')
    <!--=====HEADER START=======-->
    <x-topbar logo="/img/logo/header-logo6.svg" exClass="6">
    ...
    <div class="service6 sp3" style="background-color: #10242D;">
        <div class="container">
            <div class="row">
    ...
    <div class="tes6 sp3" style="background-color: #ECF5F6;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto text-center">
                    <div class="hadding6">
    ...
    <div class="contact6 sp3" style="background-color: #ECF5F6;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hadding6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="" data-aos="fade-right" data-aos-duration="1000">
                                        <button class="theme-btn7">Submit Now</button>
                                    </div>
                                </div>
