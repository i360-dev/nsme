@extends('layouts.base', ['title' => 'Home 1 || Business Consulting Consulting', 'logo' => '/img/logo/titel2.svg'])
...
@section('content')
    <!--=====HEADER START=======-->
    <x-topbar logo="/img/logo/header2-logo.svg" exClass="2">
                ...
                <div class="col-lg-7 col-md-12">
                    <div class="main-hadding2">
                        ...
                        <h1 data-aos="fade-right" data-aos-duration="700">Transform Your <span
                                class="after2">Business</span> with Expert Consulting Services</h1>
                        <div class="space24"></div>
                        <p data-aos="fade-right" data-aos-duration="900">Unlock Your Potential and Drive Growth. We help
                            business to perform with our <br> customized solutions helping them take business decisions.</p>
                ...
                <div class="col-lg-6">
                    <div class="hadding2 about2-hadding">
                        ...
                        <h1 data-aos="fade-left" data-aos-duration="800">Partner with Our <span
                                class="after2">Trusted</span> Consultants Today.</h1>
                        <div class="space24"></div>
                        ...
                        <p data-aos="fade-left" data-aos-duration="700">your unique challenges and goals to deliver
                            customized solutions tailored to your specific needsWe are committed to providing exceptional
                        ...
                        <div class="service2-box">
                            ...
                            <div class="service2-hadding hadding2-w">
                                ...
                                <p>Our experienced consultants help develop strategic plans to drive business growth,
                                    improve operations, and achieve long-term...</p>
                                <div class="space24"></div>
                ...
                <div class="col-lg-6">
                    <div class="hadding2">
                        ...
                        <p data-aos="fade-right" data-aos-duration="800">At Advisor Consulting Company, we are a trusted
                            business consulting firm dedicated to helping businesses thrive and reach their full
                            potential.Our team of experienced consultants brings diverse industry knowledge and expertise in
                            various business disciplines.</p>
                        <div class="space20"></div>
                ...
                <div class="col-lg-6">
                    <div class="hadding2-w">
                        ...
                        <p data-aos="fade-right" data-aos-duration="900">We are here to help you feel happy and healthy
                            again through our revolutionary healthcare model that's evidence-based, supportive, and
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-footer mr50">
                        ...
                        <p>
                            ...
                            protected by the best. See our featured carrier list here.
                        </p>
                    </div>
                </div>
