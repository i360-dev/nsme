...
@section('content')
    <!--=====HEADER START=======-->
    <x-topbar headClass="header-area5" logo="/img/logo/header-logo7.svg" exClass="7">
        <div class="home2-header-buttons">
            <div class="header6-buttons">
                <a href="tel:+1(888)423-3526" class="header6-btn"> <span><img src="/img/icons/header6-phn-icon.svg"
                            alt=""></span> +1 (888) 423-3526</a>
                <a href="{{ route('second', ['others', 'contact'])}}" class="theme-btn8">Contact Us <span><i class="fa-solid fa-arrow-right"></i></span></a>
            </div>
        </div>
    </x-topbar>
    ...
    <!--=====service start=======-->
    <div class="service7 sp3" style="background-color: #0C1217;">
        <div class="container">
            <div class="row">
    ...
    <!--=====team start=======-->
    <div class="team7 sp3" style="background-color: #F4F3EF;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto text-center">
                    <div class="hadding7">
    ...
    <!--=====contact start=======-->
    <div class="contact5 sp3" style="background-color: #F4F3EF;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto text-center">
                    <div class="hadding7">
