@extends('layouts.base', ['title' => 'Home 5 || Business Consulting Consulting', 'logo' => '/img/logo/titel5.svg'])
...
@section('content')
    <!--=====HEADER START=======-->
    <x-topbar logo="/img/logo/header-logo5.svg" exClass="5">
    ...
    <div class="about5 sp3" style="background-color: #F1F1F5;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-6 m-auto text-center">
                    <div class="hadding5">
                        ...
                        <div class="space16"></div>
                        <p data-aos="fade-up" data-aos-duration="900">Our team of experienced consultants combines industry
                            knowledge,
    ...
    <div class="blog5 sp3" style="background-color: #F1F1F5;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto text-center">
                    <div class="hadding5">
